...
public class BuscaAprofundamentoImperativo {
    ...
    public static ArrayList<Nó> busca(Integer entrada,Integer procurado,ArrayList<Ponto> grafo){
        ...
        for(;lista.size()!=0&&procurado!=lista.get(0).atual.posicao;){
            ...
            if(lista.get(0).profundidade<10){
            Nó no0= new Nó();
            ...
            no0.profundidade=lista.get(0).profundidade+1;
            ...
            if(lista.get(0).atual.vizinhos.size()>1){
                ...
                no1.profundidade=lista.get(0).profundidade+1;
            ...
            if(lista.get(0).atual.vizinhos.size()>2){
                ...
                no2.profundidade=lista.get(0).profundidade+1;
            ...
            if(lista.get(0).atual.vizinhos.size()>3){
                ...
                no3.profundidade=lista.get(0).profundidade+1;
